				    ...
				    while($v<=$count){
						...
						for ($x=1; $x <=$count2 ; $x++) { 
							...
							//MANEJO DE PRECIOS COMBINADOS----------------------------------------------------
					 		...
					 		//------------------------------------------------------------------------------------
							//$option_params .= "TotalFare:'$TotalFare',BaseFare:'$BaseFare',ImpTasas:'$ImpTasas',Cargos:'$Cargos',BaseFareAdulto:'$BaseFareAdulto',BaseFareBebe:'$BaseFareBebe',BaseFareNino:'$BaseFareNino'},";
							$option_params = substr($option_params,0,-1) . ")}";
