				...
				for ($j=$i+1; $j <=2 ; $j++) { 
				    ...
				    while($v<=$count){
						...
						for ($x=1; $x <=$count2 ; $x++) { 
							...
							$html.='<br/>';
									if($OriginDestinationInformation[$j]['OriginDestinationOptions']['OriginDestinationOption'][$x]['FlightSegment'][$y]['TotalFare'][0]!=null)
									...
									if($OriginDestinationInformation[$j]['OriginDestinationOptions']['OriginDestinationOption'][$x]['FlightSegment'][$y]['BaseFare'][0])
									...
									if($OriginDestinationInformation[$j]['OriginDestinationOptions']['OriginDestinationOption'][$x]['FlightSegment'][$y]['ImpTasas'][0])
									...
									if($OriginDestinationInformation[$j]['OriginDestinationOptions']['OriginDestinationOption'][$x]['FlightSegment'][$y]['Cargos'][0])
							...
							if($TotalFare!=0){
								...
								$html.='
								 ...
								 $html.='   </div>
								               <div class="col-sm-12 col-md-6 col-lg-6">
								               	<span class="text_datos_precio">Bsf. '.number_format($BaseFare,2,'.',',').'</span>
								               </div>
											</div>
											<div class="row">	
								               <div class="col-sm-12 col-md-6 col-lg-6">
