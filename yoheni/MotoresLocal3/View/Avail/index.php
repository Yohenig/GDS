											    	...
											    	<div class="container row">
											    		<div class="col-sm-3 col-md-3">
											    			...
											    			<div class="input-group">
															    ...
															    <input type="text" data-ride="spinner" name="adulto" id="adulto" class="form-control input-number" value="1" data-min="1" data-max="9">
															    <span class="input-group-btn">
															        <button type="button" class="btn btn-default" data-value="2" data-target="#adulto" data-toggle="spinner" data-on="mousehold">
													...
													<div class="container row">
											    		<div class="col-sm-3 col-md-3">
											    			...
											    			<div class="input-group">
															    ...
															    <input type="text" data-ride="spinner" name="mayor" id="mayor" class="form-control input-number" value="0" data-min="1" data-max="9">
															    <span class="input-group-btn">
															        <button type="button" class="btn btn-default" data-value="2" data-target="#mayor" data-toggle="spinner" data-on="mousehold">
															            <span class="glyphicon glyphicon-plus-sign"></span>
															        </button>
															    </span>
															</div>
													...
													<div class="container row">
											    		<div class="col-sm-3 col-md-3">
											    			...
											    			<div class="input-group">
															    ...
															    <input type="text" data-ride="spinner" name="nino" id="nino" class="form-control input-number" value="0" data-min="1" data-max="9">
															    <span class="input-group-btn">
															        <button type="button" class="btn btn-default" data-value="2" data-target="#nino" data-toggle="spinner" data-on="mousehold">
															            <span class="glyphicon glyphicon-plus-sign"></span>
															        </button>
															    </span>
															</div>
													...
													<div class="container row">
											    		<div class="col-sm-3 col-md-3">
											    			...
											    			<div class="input-group">
															    ...
															    <input type="text" data-ride="spinner" name="bebe" id="bebe" class="form-control input-number" value="0" data-min="1" data-max="1">
															    <span class="input-group-btn">
															        <button type="button" class="btn btn-default" data-value="2" data-target="#bebe" data-toggle="spinner" data-on="mousehold">
															            <span class="glyphicon glyphicon-plus-sign"></span>
															        </button>
															    </span>
															</div>
