...
{
	background-color: <?php echo $_SESSION['theme_color'];?>;
}
/*Preset 2*/
...
{
color :<?php echo $_SESSION['theme_color'];?>;
}
/*Preset 2*/
...
{
		border-color: <?php echo $_SESSION['theme_color'];?>;
}
/*Preset 1*/
...

{
		...
		border-color: <?php echo $_SESSION['theme_color'];?> rgba(0, 0, 0, 0);
		opacity:0.9;
}
...
{
background: <?php echo $_SESSION['theme_color'];?> none repeat scroll 0px 0px;
}

/** k2 ***/
.sort-by-section .swap-tiles li:hover > a > i, .sort-by-section .swap-tiles li.active > a > i
{
	background: <?php echo $_SESSION['theme_color'];?> none repeat scroll 0 0;
...
{
	background-color: <?php echo $_SESSION['theme_color'];?>;
    border-color: <?php echo $_SESSION['theme_color'];?> <?php echo $_SESSION['theme_color'];?> rgba(0, 0, 0, 0);
	color:#fff;
}
...
{
	 border-right-color:<?php echo $_SESSION['theme_color'];?>;
}
